...
namespace Freeroam.Freemode.Phone
{
	...
	public static class PhoneAppHolder
	{
		...
		{
			new PhoneApp(PhoneAppIcon.APP_MESSAGING, Strings.PHONE_APP_MESSAGES, typeof(AppMessages)),
			new PhoneApp(PhoneAppIcon.APP_GROUP, Strings.PHONE_APP_PLAYERLIST, typeof(AppPlayerlist)),
            new PhoneApp(PhoneAppIcon.APP_CONTACTS, Strings.PHONE_APP_CONTACTS, typeof(AppContacts)),
            new PhoneApp(PhoneAppIcon.APP_RSS, Strings.PHONE_APP_RADIO, typeof(AppRadio)),
			new PhoneApp(PhoneAppIcon.APP_TRACKIFY, Strings.PHONE_APP_TRACKIFY, typeof(AppTrackify), true),
